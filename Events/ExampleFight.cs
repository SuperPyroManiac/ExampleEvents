...
[EventInfo("An example Fight", "Stop the fight, and make sure everyone is ok.")]
public class ExampleFight : AmbientEvent
{
    ...
    {
        //Setup
        PyroFunctions.FindSideOfRoad(120, 45, out var _spawnPoint, out _);
        ...
        try
        {
            switch (_tasks)
            {
                ...
                case Tasks.OnScene:
                    ...
                    Game.LogTrivial("ExampleEvent: Fight event picked scenerio #" + choice);
                    switch (choice)
                    {
                        case 1:
